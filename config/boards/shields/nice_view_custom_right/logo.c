/*
 * Green Lantern logo - right half
 *
 * PLACEHOLDER: Este archivo contiene un borde simple como prueba.
 * Para usar el logo real de Green Lantern:
 *
 *   1. Consigue un PNG monocromatico de 160x68 px (o menor, con padding)
 *   2. Ejecuta: python3 scripts/png_to_c_array.py greenlantern.png greenlantern
...
static const uint8_t logo_map[] = {
    ...
    /* PLACEHOLDER: rectangulo borde - reemplazar con logo Green Lantern */
